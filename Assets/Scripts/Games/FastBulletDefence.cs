...
public class FastBulletDefence : Games
{
    ...
    IEnumerator SpawnBullets()
    {
        while (true)
        {
            yield return new WaitForSeconds(0.4f); // 더 빠른 간격으로 총알 발사
